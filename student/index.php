...
if (isset($save)) {
    if ($e == "" || $p == "") {
        ...
        if ($r) {
            ...
            $to = $e; // User's email address
            $subject = "Login Successful";
            $message = "Dear " . $res['e_id'] . ",\n\nYou have successfully logged in to your account.";
            $headers = "From: winash2626@gmail.com"; // Replace with your email address
            ...
            if (mail($to, $subject, $message, $headers)) {
                ...
                echo "<script>window.location='studentdashboard.php'</script>";
                $err = "<font color='red'>Failed to send email</font>";
            }
        } else {
