...
<html lang="en">
    ...
    <title>Time Table Creator and Manager</title>
...
<script src="js/bootstrap.min.js"></script>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand"><font color="#FF0000">Time Table Creator and Manager</font></a>
    </div>
...
<header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1>Time Table Creator and Manager</h1>
                <hr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-12 text-center">
                        <h2 class="section-heading">About Time Table Creator and Manager</h2>
                        <hr class="primary">
                    </div>
...
if(isset($save))
{
	$emailExistsQuery = mysqli_query($con, "SELECT * FROM contactus WHERE email='" . $eid . "'");
